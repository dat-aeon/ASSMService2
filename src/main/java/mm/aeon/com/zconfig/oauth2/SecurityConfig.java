...
public class SecurityConfig extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
	...
	@Value("${properties.outletImageFolder}")
	private String outletImageFolder;
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		registry.addResourceHandler("/outlet-image-files/**").addResourceLocations("file:///" + imageBaseFilePath + outletImageFolder);
	}
}